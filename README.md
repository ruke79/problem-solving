...
- 답변 원고 **Q1~Q200 전 범위**를 대조해 사실·표현 오류 9건을 확정했다 —
  적용 가능한 형태로 모은 것이 `docs/10-원고-수정-지시서.md`
- 만드는 과정에서 나온 문제와 해결(22건)은 `docs/05-개발-중-문제와-해결.md`
...
| `docs/05-개발-중-문제와-해결.md` | 빌드·이관·측정 하네스에서 나온 문제 22건과 해결 |
...
| `docs/10-원고-수정-지시서.md` | 확정된 원고 수정 9건을 적용 가능한 형태로 정리 |
